...
temp = randperm(19591);  
inputTrainDataset = data(temp(1:2000), 1:13)';
outputTrainDataset = data(temp(1:2000), 14)';

inputTestDataset = data(temp(19091:19591), 1:13)';
outputTestDataset = data(temp(19091:19591), 14)';
...
model_name = sprintf('Currently running, SO-BP neural network prediction program.');
disp(model_name);
disp('running... ...')
% tic; 
...
func_num=1;
POS=tent_chaos_init(popsize,dim,lb,ub);
[curve, optimized_param]=TBESO(fobj,popsize,POS,maxgen,lb,ub,dim,func_num);
